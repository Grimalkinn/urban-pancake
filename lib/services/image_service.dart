...
8. Photos
Subject to your compliance with these API Terms, all Photos that are made available through the APIs are provided pursuant to the Unsplash License and Unsplash Terms & Conditions, except that, if you receive Unsplash’s prior written consent, you additionally have the right to sublicense your rights to Photos that are made available to you through the APIs.
